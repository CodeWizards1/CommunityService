...
var file_UserManagementService_userManagementService_proto_rawDesc = []byte{
	...
	0x0b, 0x75, 0x73, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x66, 0x69, 0x6c, 0x65, 0x32, 0xed, 0x02, 0x0a,
...
var file_UserManagementService_userManagementService_proto_depIdxs = []int32{
	...
	0, // 5: User.UserManagementService.GetUserProfileById:input_type -> User.IdUserRequest
	5, // 6: User.UserManagementService.UpdateUserProfileById:input_type -> User.UserProfileRequest
	...
	6, // 10: User.UserManagementService.GetUserProfileById:output_type -> User.UserProfileResponse
	6, // 11: User.UserManagementService.UpdateUserProfileById:output_type -> User.UserProfileResponse
